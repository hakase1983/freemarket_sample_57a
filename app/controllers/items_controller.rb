class ItemsController < ApplicationController
  ...
  def item_params
    params.require(:item).permit(:name,:description,:category_id,:condition,:price,images_attributes: [:name,:id],size_attributes: [:id,:name],brand_attributes: [:id,:name],delivery_attributes: [:id,:fee,:area,:delivery_days])
  end
